    ...
    .service('FluroAccess', function($rootScope, $q, FluroContent) {
        ...
        controller.retrieveSelectableRealms = function(action, type, parentType, noCache) {
            ...
            if (controller.isFluroAdmin()) {
                ...
                FluroContent.endpoint('realm/tree', false, noCache).query({
                    // list: true,
                    // sort: 'title'
                ...
                var realmTree = _.chain(permissionSets)
                    ...
                    .reduce(function(results, realm) {
                        ...
                        if (realm.trail && realm.trail.length) {
                            ...
                            var parent = _.find(selectableRealms, function(pRealm) {
                ...
                //console.log('CREATEABLE REALMS', realms);
                /////////////////////////////////
